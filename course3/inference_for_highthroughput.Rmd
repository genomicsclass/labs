...
```{r qqplots_for_one_gene, fig.cap="Normal qq-plots for one gene. Left plot shows first groud and right plot shows second group.",fig.width=10.5,fig.height=5.25}
e <- geneExpression[25,]
mypar(1,2)
