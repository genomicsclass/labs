...
```{r qqnorm_of_t, fig.cap="We generate t-distributed data for four degrees of freedom and make qqplots against normal theoretical quantiles.",fig.width=10.5,fig.height=10.5}
dfs <- c(3,6,12,30)
mypar(2,2)
for(df in dfs){
  x <- rt(1000,df)
...
```{r fig.width=8, fig.height=4, fig.cap="Histogram and QQ-plot of executive pay."}
mypar(1,2)
