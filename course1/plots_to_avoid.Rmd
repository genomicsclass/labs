...
```{r correlation-not-replication, fig.cap="Gene expression data from two replicated samples. Left is in orginal scale and right in log scale.",fig.width=10.5 , fig.height=5.25}
data(mas95)
mypar(1,2)
