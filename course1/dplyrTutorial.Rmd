...
```{r}
msleep <- read.csv("dagdata/inst/extdata/msleep_ggplot2.csv")
head(msleep)
```
...
Filter the rows for mammals that sleep a total of more than 10 hours. 

```{r}
filter(msleep, sleep_total >= 16)
```

Filter the rows for mammals that sleep a toal of more than 10 hours *and* have
