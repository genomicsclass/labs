...
```{r spider_main_coef, fig.cap="MIKELOVE add caption."}
...
```{r spider_interactions, fig.cap="MIKELOVE"}
...
```{r spider_interactions2, fig.cap="MIKELOVE"}
stripchart(split(spider$friction, spider$group), 
           vertical=TRUE, pch=1, method="jitter", las=2, xlim=c(0,11), ylim=c(0,2))
...
```{r matrix_model_image_group_variable, fig.cap="MIKELOVE"}
...
```{r estimated_group_variables, fig.cap="MIKELOVE"}
stripchart(split(spider$friction, spider$group), 
           vertical=TRUE, pch=1, method="jitter", las=2, xlim=c(0,11), ylim=c(0,2))
cols <- brewer.pal(8,"Dark2")
abline(h=0)
