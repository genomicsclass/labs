...
R.A. Fisher. A person he knew claimed she could tell if milk was added
...
figure out each probability. The probability of picking 3 is ${4
\choose 3} {4 \choose 1} / {8 \choose 4} = 16/70$. The probability of
picking all 4 correct is ${4 \choose 4} {4 \choose 0}/{8 \choose 4}=
1/70$. Thus the chance of observing a 3 or something more extreme,
under the null hypothesis, is $\approx 0.24$. This is called a p-value. The
...
polymorphisms (SNP). These p-values are obtained in a similar way to
...
another approach, the Chi-squared test, which described below. 
