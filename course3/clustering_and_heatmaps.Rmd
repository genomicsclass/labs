...
```{r dendrogram, fig.cap="Dendrogram showing hierarchical clustering of tisuse gene expression data.",fig.width=10.5,fig.height=5.25}
library(rafalib)
mypar()
hc <- hclust(d)
hc
...
```{r color_dendrogram, fig.cap="Dendrogram showing hierarchical clustering of tisuse gene expression data with colors denoting tissues.",fig.width=10.5,fig.height=5.25}
...
```{r heatmap, fig.cap="Heatmap created using the 40 most variable genes."}
