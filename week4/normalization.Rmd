...
Our first example is a Dilution dataset that is not publically available. To obtain the dataset you need to request it here: http://www.genelogic.com/support/scientific-studies
...
Homework: Try various values of span different from 0.75 and change the degree. Decide which you believe to be the best and defend the choice.
...
Boxplots of all Dilution data. Obviously we don't want to normalize.
