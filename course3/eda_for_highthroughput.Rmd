...
```{r boxplots, fig.cap="Boxplot for log-scale expression for all samples."}
library(rafalib)
mypar(1,1)
...
```{r kaboxplot, fig.cap="The 0.05, 0.25, 0.5, 0.75, and 0.95 quantiles are plotted for each sample."}
