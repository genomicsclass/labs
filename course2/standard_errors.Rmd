...
This will be important to know because when we compute linear combinations of our estimates, we will need this information to correctly calculate the standard error of these linear combinations.
