---
title: "intro-using-regression.Rmd"
author: "Rafa"
...
* $\beta_0$ is chow diet average weight
* $\beta_1$ is difference between averages
* $x_i = 1$ if high fat (hf) diet
* $x_i = 0$ if chow diet
* $\varepsilon_i$ explaines differences between mice of same population
...
Linear algebra was created by mathematicians to solve systmes of linear equations such as this:
...
This section explains the notation used aboveIt turns that we can borrow this notation to linear models in statistics as well.
