...
The transpose is an operation that simply changes columns to rows. We use either a $\top$ to denote transpose.  Here is the technical definition. If X is as we defined it above, here is the transpose which will be $p\times N$:
