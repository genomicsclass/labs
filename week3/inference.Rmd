...
```{r}
stripchart(list(women,men),vertical=TRUE,method="jitter")
```
...
library(rafalib)
shist(dat$Height[dat$Gender==1],plotHist=FALSE,col=1,unit=1,xlim=range(dat$Height))
shist(dat$Height[dat$Gender==0],plotHist=FALSE,col=2,add=TRUE,unit=1)
```
