...
The inverse of matrix $X$, denoted with $X^{-1}$ has the property that, when multiplied, gives you the identity $X^{-1}X=I$. Keep in mind that not all matrices have inverses. For example, a $2\times 2$ matrix with 1s in all its entries does not have an inverse. 
