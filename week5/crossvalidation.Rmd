...
We will use the caret package to make 5 folds of the data, which are
balanced over the tissues.
Don't be confused that the caret package uses the same letter 'k' as
the k in K-nearest neighbors. These k's are unrelated. The caret
function `createFolds` is
