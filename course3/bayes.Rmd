...
Suppose we select random person and they test positive, what is the probability that they have the disease?  We write this as $\mbox{Prob}(D=1 \mid +)?$. The  cystic fibrosis rate is 1 in 3,900 which implies that  $\mbox{Prob}(D)=0.0025$. To answer this question we will use Bayes Theorem, which in general  tells us that
