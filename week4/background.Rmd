...
$$
with $Y_j$ the observed intensity for probe $j$, $\beta_j$ a background level, $\phi_j$ a multiplicative affinity affect and $\theta$, a value proportional to $\varepsilon_j$ which denotes the measurement error. 
