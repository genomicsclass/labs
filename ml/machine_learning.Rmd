...
```{r conditional_prob, fig.cap="Probability of Y=1 as a function of X1 and X2. Red is close to 1, yellow close 0.5 nad blue close to 0.", echo=FALSE}
library(rafalib)
...
```{r bayes_rule,fig.cap="Bayes rule. The line devides part of the space for which probability is larger than 0.5 (red) and lower than 0.5 (blue).",echo=FALSE}
mypar()
