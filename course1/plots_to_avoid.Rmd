...
The following figure shows three curves. Pseudo 3D is used, but it is not clear why? Maybe to separate the three curves? Notice how difficult it is to determine the values of the curves at any given point:
