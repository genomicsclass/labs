...
From the Bioconductor `variants` workflow

http://www.bioconductor.org/help/workflows/variants/

> The VCF file is available in the cgdv17 data package and contains Complete Genomics data for population type CEU.
...
print(object.size(vcf), format="Mb")
gr <- rowData(vcf)
loc <- locateVariants(gr, txdb, CodingVariants())
head(loc, 3)
```
