...
Commonly we want to compute the standard deviation of a linear combination of estimates such as 
...
We know how to compute the variance covariance matrix of $\hat{\boldsymbol{\beta}}$
