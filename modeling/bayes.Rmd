...
Note that it is a weighted average of the population average $\mu$ and the observed data $Y$. The weight depends on the SD of the the population $\tau$ and the SD of our observed data $\sigma$. In the case of José Iglesias, we have:
